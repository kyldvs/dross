...
Innovation means solving problems in new ways, not using new technology for its
own sake.
...
Code exists to solve problems. If it doesn't make the product more useful, it
doesn't belong.
...
Code is read far more than written. Aesthetic code is pleasant to read and
reveals its intent.
...
Good abstractions fade into the background, letting you focus on the problem
domain.
...
Quality is in the details. Incomplete work creates friction for everyone who
follows.
